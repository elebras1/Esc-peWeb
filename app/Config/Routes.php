...
$routes->get('scenario/afficher_1ere_etape/(:num)/(:num)', [Scenario::class, 'afficher_1ere_etape']);
$routes->get('scenario/afficher_1ere_etape/(:num)/', [Scenario::class, 'afficher_1ere_etape']);
