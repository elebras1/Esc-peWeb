    ...
    <main>
                    ...
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="pages/listing-page.html">Listing Page</a></li>

                                <li><a class="dropdown-item" href="pages/detail-page.html">Detail Page</a></li>

                                <li><a class="dropdown-item" href="pages/upload.php">Upload</a></li>
                            </ul>
                        </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="text-center mb-5 pb-2">
                            ...
                            <a href="#section_2" class="btn custom-btn smoothscroll mt-3">Commencer un scénario</a>
                        </div>
        ...
        <div class="container">
            <?php
                ...
                */
                $requete2 = "SELECT snr_intitule, snr_image FROM t_scenario_snr WHERE snr_id = 1;";
                //echo($requete2);
                ...
                $snr_image = $resultat2->fetch_assoc();

                echo("<h5 class='mb-1'>" . $snr_image['snr_intitule'] . "</h5>");
                echo ("<img src='" . "documents/" . $snr_image['snr_image'] . "' class='custom-block-image img-fluid' alt=''>");
                        ...
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    ...
                                    <a href="pages/detail-page.html" class="custom-block-image-wrap">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-overlay">
                            ...
                            <div class="custom-block-info custom-block-overlay-info">
                                <h5 class="mb-1">
                                    <a href="pages/listing-page.html">
                                        Productivity
                                    </a>
                                </h5>
